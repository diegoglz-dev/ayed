...
public class TestCiudadesCovid2 {
	public static void main(String[] args) {
		...
		CiudadesCovid2 ciudadesCovid = new CiudadesCovid2();
		...
		ListaGenerica<String> lis = ciudadesCovid.resolver(ciudades,"La Plata","Suipacha",pasandoPor);
		lis.comenzar();
		while(!lis.fin()) {
