...
public class TestCiudadesCovid {
	public static void main(String[] args) {
		...
		CiudadesCovid ciudadesCovid = new CiudadesCovid();
		
		ListaGenerica<Ciudad> lis = ciudadesCovid.resolver(ciudades, "La Plata", "Carlos Keen");
		lis.comenzar();
		while(!lis.fin()) {
