...
public class TestProfundidadDeArbolBinario {
	...
	public static void main(String[] args) {
		...
		int nroProfundidad = 2;
		ProfundidadDeArbolBinario profundidad = new ProfundidadDeArbolBinario(a10);
		
		System.out.println("La suma en la profundidad "+ nroProfundidad + " es: " + profundidad.sumaElementosProfundidad(nroProfundidad));
	}
}
